...
import pl.admund.MVM_Servlet.League.League;
...
import pl.admund.MVM_Servlet.Team.TeamTactic;
...
public class SQLQueryCreator
{
	public static String addPlayer(Player _player)
	{
		...
		query += _player.getTeamId()+", 0, ";
		query += "'"+_player.getMail()+"')";
	...
	public static String addMatch(Match _match)
	{
	...
	public static String updateMatch(Match _match)
	{
	...
	public static String updateMatch(int matchId, int homeSetWon, int awaySetWon, String littlePts)
	{
		...
		query += "STATUS=" + Match.STATUS_MATCH_END + " ";
	...
	public static String addMatchRandResult(Match _match)
	{
