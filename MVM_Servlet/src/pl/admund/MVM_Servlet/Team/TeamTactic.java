...
public class TeamTactic
{
	...
	public static enum enumRecArea { Mieszany, Wiecej, Mniej };
	...
	public static TeamTactic creatRandomTeamTactic()
	{
		...
		tmpTeamTactic.teamRecArea = enumRecArea.Mieszany;
		...
		tmpTeamTactic.rec1RecArea = enumRecArea.Mieszany;
		...
		tmpTeamTactic.rec2RecArea = enumRecArea.Mieszany;
		...
		tmpTeamTactic.libRecArea = enumRecArea.Mieszany;
