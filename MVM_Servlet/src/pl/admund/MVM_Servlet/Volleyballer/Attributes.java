...
public class Attributes
{
	...
	{
		Element rootPlayer = doc.createElement("attributes");
		rootElement.appendChild(rootPlayer);
		
		XMLUtils.addToXMLDoc(doc, rootPlayer, "atack", "" + atack);
		XMLUtils.addToXMLDoc(doc, rootPlayer, "block", "" + block);
		XMLUtils.addToXMLDoc(doc, rootPlayer, "reception", "" + reception);
		XMLUtils.addToXMLDoc(doc, rootPlayer, "rozegranie", "" + rozegranie);
		XMLUtils.addToXMLDoc(doc, rootPlayer, "serwis", "" + serwis);
		XMLUtils.addToXMLDoc(doc, rootPlayer, "technique", "" + technique);
		
		XMLUtils.addToXMLDoc(doc, rootPlayer, "temper", "" + temper);
		XMLUtils.addToXMLDoc(doc, rootPlayer, "ustawianie", "" + ustawianie);
		XMLUtils.addToXMLDoc(doc, rootPlayer, "intuition", "" + intuition);
		XMLUtils.addToXMLDoc(doc, rootPlayer, "creativity", "" + creativity);
		XMLUtils.addToXMLDoc(doc, rootPlayer, "walecznosc", "" + walecznosc);
		XMLUtils.addToXMLDoc(doc, rootPlayer, "charisma", "" + charisma);
		
		XMLUtils.addToXMLDoc(doc, rootPlayer, "strenght", "" + strenght);
		XMLUtils.addToXMLDoc(doc, rootPlayer, "jumping", "" + jumping);
		XMLUtils.addToXMLDoc(doc, rootPlayer, "reflex", "" + reflex);
		XMLUtils.addToXMLDoc(doc, rootPlayer, "quickness", "" + quickness);
		XMLUtils.addToXMLDoc(doc, rootPlayer, "agility", "" + agility);
		XMLUtils.addToXMLDoc(doc, rootPlayer, "stamina", "" + stamina);
		
		XMLUtils.addToXMLDoc(doc, rootPlayer, "talent", "" + talent);
		XMLUtils.addToXMLDoc(doc, rootPlayer, "psychoforce", "" + psychoforce);
		XMLUtils.addToXMLDoc(doc, rootPlayer, "pracowitosc", "" + pracowitosc);
